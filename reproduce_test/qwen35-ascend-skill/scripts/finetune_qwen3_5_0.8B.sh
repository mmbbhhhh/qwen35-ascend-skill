...
cd /workspace/reproduce_test/qwen35-ascend-skill
...
config_path=/workspace/reproduce_test/qwen35-ascend-skill/configs/qwen3_5_0.8B_config.yaml   #需要修改的告诉config在哪里
